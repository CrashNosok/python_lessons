...
class JediSwap(Base):
    ...
    async def swap_eth_to_token(self, amount_in: TokenAmount, token_name: str):
        ...
        try:
            ...
            swap_call = jediswap_contact.functions['swap_tokens_for_exact_tokens'].prepare_call(**swap_args)
    ...
    async def swap_token_to_eth(self, token_name: str):
        ...
        try:
            ...
            swap_call = jediswap_contact.functions['swap_exact_tokens_for_tokens'].prepare_call(**swap_args)
